@ECHO OFF
::========================================
SET GITHUB_ACCOUNT=lkovalch
SET WS_DIR=Workspace
SET REPO_NAME=Title_Validation_CSV
SET APP_VERSION=1.1
SET MAIN_CLASS=core.HtmlUnit_throws
::========================================
...
java -jar C:\%WS_DIR%\%REPO_NAME%\target\%REPO_NAME%-%APP_VERSION%-jar-with-dependencies.jar GOTO END
